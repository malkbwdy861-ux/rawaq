...
export async function generateMetadata(): Promise<Metadata> { const result = await getPublishedPage("ABOUT"); return staticPageMetadata(result.version, result.data); }
