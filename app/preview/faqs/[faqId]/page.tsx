...
export default async function FaqPreviewPage({ params }: FaqPreviewPageProps) {
  ...
  return <main className="min-h-screen bg-[oklch(97.5%_0.009_100)] px-4 py-10 md:px-8"><div className="mx-auto max-w-3xl space-y-12">
    <div className="rounded-[8px] border border-[oklch(47%_0.10_75)] bg-[oklch(94%_0.035_80)] p-4 text-[oklch(47%_0.10_75)]"><p className="font-semibold">معاينة محمية لمسودة غير منشورة</p><Link className="mt-2 inline-flex min-h-11 items-center text-sm font-semibold underline" href="/dashboard/faqs">العودة إلى الأسئلة</Link></div>
