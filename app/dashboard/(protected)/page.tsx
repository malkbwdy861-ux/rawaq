...
export default async function DashboardPage() {
  ...
  const [
    ...
    prisma.service.findMany({ select: { id: true, status: true, draftVersionId: true, publishedVersionId: true, updatedAt: true, draftVersion: { select: { title: true } }, publishedVersion: { select: { title: true } } }, orderBy: [{ updatedAt: "desc" }, { id: "desc" }], take: 6 }),
    prisma.project.findMany({ select: { id: true, status: true, draftVersionId: true, publishedVersionId: true, updatedAt: true, draftVersion: { select: { title: true } }, publishedVersion: { select: { title: true } } }, orderBy: [{ updatedAt: "desc" }, { id: "desc" }], take: 6 }),
    prisma.article.findMany({ select: { id: true, status: true, draftVersionId: true, publishedVersionId: true, updatedAt: true, draftVersion: { select: { title: true } }, publishedVersion: { select: { title: true } } }, orderBy: [{ updatedAt: "desc" }, { id: "desc" }], take: 6 }),
