...
export default async function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[oklch(97.5%_0.009_100)] text-[oklch(22%_0.018_155)] lg:flex lg:flex-row-reverse">
      ...
      <aside className="border-l border-[oklch(82%_0.012_145)] bg-[oklch(96.5%_0.009_120)] p-4 lg:sticky lg:top-0 lg:h-screen lg:w-[264px] lg:shrink-0 lg:overflow-y-auto">
