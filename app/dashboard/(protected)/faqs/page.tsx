...
import { CreateFaqDialog, DeleteFaqDialog, FaqDialog } from "@/modules/faqs/components/create-faq-dialog";
...
function FaqActions({ faq, question }: { faq: NonNullable<Parameters<typeof FaqDialog>[0]["faq"]>; question?: string | null }) {
  return <div className="flex items-center justify-end gap-1"><FaqDialog faq={faq} /><DeleteFaqDialog faqId={faq.id} question={question} /></div>;
}
