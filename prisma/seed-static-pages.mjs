...
function buildPages({ serviceIds, solutionIds, projectIds, faqIds, pricingArticleIds }) {
  return [
    ...
    listingPage("GUIDES", "أدلة واضحة لاختيار ما يناسب موقعك", "معرفة عملية، قبل قرار التنفيذ", "معلومات عملية عن المواد والأسعار والصيانة والمقارنات، مرتبة لتصل إلى القرار بثقة.", "محتوى يساعدك على اتخاذ قرار أوضح", "استكشف أدلة عملية تشرح خيارات التظليل والمواد وعوامل الأسعار ومتطلبات الصيانة، لتفهم البدائل قبل بدء التنفيذ.", "الأدلة", "أدلة عملية منشورة حول التظليل والمواد والأسعار والصيانة."),
    listingPage("MATERIALS", "مواد واضحة لاختيارات تدوم", "دليل المواد", "قارن خصائص المواد واستخداماتها وحدودها قبل اختيار ما يلائم الموقع وظروفه.", "اختيار المادة يبدأ من ظروف الموقع", "اختيار المادة لا يعتمد على الشكل وحده. الحرارة، التعرض للشمس، الاستخدام، والصيانة المطلوبة كلها عوامل تساعد على تحديد الخيار الأنسب للموقع.", "المواد", "تصفح المواد والخيارات المنشورة والمدعومة في أعمال رواق شيدز."),
  ];
}
