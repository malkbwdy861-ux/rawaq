  ...
  return (
    <form action={formAction} noValidate ref={formRef}>
      ...
      <header className="mb-6 border-b border-border pb-5">
        <Link className="inline-flex min-h-8 items-center text-xs font-medium text-muted-foreground outline-none transition-colors hover:text-brand-accent-strong focus-visible:ring-2 focus-visible:ring-ring" href="/dashboard/solutions">الحلول <span aria-hidden="true" className="mx-1.5">/</span> <span className="text-foreground">{title}</span></Link>
