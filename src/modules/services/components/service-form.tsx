    ...
    <form action={saveServiceDraftAction}>
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,820px)_300px]">
        <div className="rounded-xl border border-border bg-card px-5 shadow-[var(--shadow-rest)] sm:px-7">
          <EditorSection title="المعلومات الأساسية" description="العنوان والرابط والملخص الظاهر في قوائم الموقع.">
            ...
            <CmsFieldShell id="shortDescription" label="الوصف المختصر" hint="جملة أو جملتان تساعدان الزائر على فهم الخدمة بسرعة."><textarea className={`${cmsInputClassName} min-h-24 resize-y`} id="shortDescription" name="shortDescription" defaultValue={draft?.shortDescription ?? ""} /></CmsFieldShell>
          </EditorSection>
