...
export const siteSettingsSchema = z.object({
  ...
  defaultSeoTitle: z.string().trim().max(70, "عنوان SEO طويل جداً.").optional().or(z.literal("")),
  defaultSeoDescription: z.string().trim().max(170, "وصف SEO طويل جداً.").optional().or(z.literal("")),
